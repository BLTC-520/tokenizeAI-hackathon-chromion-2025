...
// KYC Contract Mapping
export const KYC_CONTRACT_BY_CHAIN = {
	[ETHEREUM_SEPOLIA_CHAIN_ID]: KYC_CONTRACT_ADDRESSES.ETHEREUM_SEPOLIA,
	[BASE_SEPOLIA_CHAIN_ID]: KYC_CONTRACT_ADDRESSES.BASE_SEPOLIA,
	[AVALANCHE_FUJI_CHAIN_ID]: KYC_CONTRACT_ADDRESSES.AVALANCHE_FUJI,
} as const;
...
export const getCurrentChainKYCContract = (chainId?: number): string => {
	if (!chainId) return KYC_CONTRACT_ADDRESS;
	return KYC_CONTRACT_BY_CHAIN[chainId as keyof typeof KYC_CONTRACT_BY_CHAIN] || KYC_CONTRACT_ADDRESS;
};

// Chainlink Functions Configuration
export const CHAINLINK_CONFIG = {
	DON_ID: process.env.CHAINLINK_DON_ID || 'fun-avalanche-fuji-1',
	DON_HOSTED_SECRETS_SLOT_ID: parseInt(process.env.DON_HOSTED_SECRETS_SLOT_ID || '0'),
	DON_HOSTED_SECRETS_VERSION: parseInt(process.env.DON_HOSTED_SECRETS_VERSION || '1750340762'),
	SUBSCRIPTION_ID: parseInt(process.env.CHAINLINK_SUBSCRIPTION_ID || '15603'),
	GAS_LIMIT: 500000,
